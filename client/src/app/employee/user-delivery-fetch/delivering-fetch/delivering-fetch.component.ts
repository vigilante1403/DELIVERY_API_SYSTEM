...
@Component({
  selector: 'app-delivering-fetch',
  templateUrl: './delivering-fetch.component.html',
  styleUrls: ['./delivering-fetch.component.scss']
})
export class DeliveringFetchComponent {
